...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        """
        self.order_total = self.lineitems.aggregate(Sum('lineitem_total'))['lineitem_total__sum'] or 0  # if all line items are deleted, set to 0 so no error if order total is zero
